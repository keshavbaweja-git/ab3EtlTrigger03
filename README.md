...
```bash
ab3EtlTrigger03$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
ab3EtlTrigger03$ sam logs -n HelloWorldFunction --stack-name ab3EtlTrigger03 --tail
```
...
```bash
ab3EtlTrigger03$ cd HelloWorldFunction
...
```bash
aws cloudformation delete-stack --stack-name ab3EtlTrigger03
```
